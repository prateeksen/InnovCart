...
<?php
	if(isset($_POST['newsubmit'])){
		...
		$hash = unserialize(file_get_contents("http://vimeo.com/api/v2/video/$youlink.php"));

		$thumbn=$hash[0]['thumbnail_medium']; 
		
		$youlength=$youlengthhh.":".$youlengthmm.":".$youlengthss;
		
		$sql="INSERT INTO `videos`(`subcat_id`, `cat_name`, `is_vimeo`, `vimeo_link`, `views`, `likes`, `snapshot_link`, `vid_length`, `vid_name`, `vid_keywords`, `vid_robots`, `vid_by`) VALUES ('$yousubcat','$youcat','yes','$youlink','$youvc','$youlc','$thumbn','$youlength','$youname','$youkey','$yourobots','$youby')";
...
<div class="panel panel-primary">
  ...
  <div class="panel-footer">
					<ul class="nav nav-pills">
					  ...
					  <li class="active"><a href="vimeo.php">Vimeo Upload</a></li>
					  <li><a href="dailymotion.php">Dailymotion Upload</a></li>
					</ul><hr/>
	<form action="#" method="POST">
		<table class="table table-hover">
			...
			<tr class="alert-success">
				<td>Vimeo Link</td>
				<td colspan="3"><input type="text" class="form-control" placeholder="Enter Link [for ex : 194361952]" name="youlink" /></td>
			</tr>
			<tr class="alert-success">
