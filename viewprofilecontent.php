...
<?php
	if(isset($_GET['user'])){
		$usrnm=strip_tags($conn->real_escape_string($_GET['user']));
...
<div class="panel panel-primary">
 ...
 <div class="panel panel-primary">
  ...
  <div class="panel-footer">
    ...
    <li class="active"><a data-toggle="tab" href="#watchhis">Watch History</a></li>
    <li><a data-toggle="tab" href="#likehis">Liked Videos</a></li>
  </ul>
  ...
  <div class="tab-content">
	...
	if($result->num_rows > 0){
		while($row=$result->fetch_assoc()){
			echo '<a class="col-sm-12" style="text-decoration:none;" title="'.$row['vid_name'].'" href="showvideo.php?id='.$row['vid_id'].'">
			<div class="list-group">
			  ...
			  }else if($row['is_vimeo']){
				  echo $row['snapshot_link'];
			  }else if($row['is_dailymotion']){
				  echo 'http://www.dailymotion.com/thumbnail/video/'.$row['dailymotion_link'];
			  }
			  echo '" style="height: 100px;width: 100px;">
			  </td><td><b>Watched on </b></td><td>'.$row['watch_time'].'</tr>
			  <tr></td><td><b>Name </b></td><td>'.$row['vid_name'].'</tr>
			  <tr><td><b>Length </b></td><td><span class="badge">'.$row['vid_length'].'</span></td></tr>
