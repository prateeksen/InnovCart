...
<?php
	if(isset($_POST['newsubmit'])){
		...
		$sql="INSERT INTO `videos`(`subcat_id`, `cat_name`, `is_youtube`, `youtube_link`, `views`, `likes`, `snapshot_link`, `vid_length`, `vid_name`, `vid_keywords`, `vid_robots`, `vid_by`) VALUES ('$yousubcat','$youcat','yes','$youlink','$youvc','$youlc','$youlink','$youlength','$youname','$youkey','$yourobots','$youby')";
...
<div class="panel panel-primary">
  ...
  <div class="panel-footer">
					<ul class="nav nav-pills">
					  ...
					  <li class="active"><a href="youtube.php">Youtube Upload</a></li>
	...
	<form action="#" method="POST">
		<table class="table table-hover">
			...
			<tr class="alert-success">
				<td>Youtube Link</td>
				<td colspan="3"><input type="text" class="form-control" placeholder="Enter Link [for ex : DNqfKnfgC1c]" name="youlink" /></td>
			</tr>
			<tr class="alert-success">
