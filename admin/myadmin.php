...
<?php
	...
	if(isset($_POST['login'])){
		...
		$sql="SELECT * FROM admin_details WHERE admin_user='$username' and admin_pass='$password'";
...
<div class="loginmodal-container">
	<?php
		if(isset($err_msg)){
			echo '<div class="alert alert-warning">Wrong Password and username Combination.</div>';
		}
	?>
