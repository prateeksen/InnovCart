...
if(!isset($_SESSION['user'])){
 ...
 <?php
	if(isset($_POST['editsub'])){
		...
		$sql="UPDATE `categories` SET `cat_name`='$cname',`cat_robots`='$robots',`cat_description`='$desc',`cat_keywords`='$key' WHERE `cat_id`='$editid'";
 ...
 <?php
	...
	$catrobots=$row['cat_robots'];
	$catdesc=$row['cat_description'];
	$catkey=$row['cat_keywords'];
?>
<html>
	<head>
	...
	<body>
		<div class="container-flow">
			<div class="panel panel-primary">
				  <div class="panel-body list-group-item active"><center><span class="glyphicon glyphicon-edit"></span> Edit Category</center></div>
				  <div class="panel-footer">
				  <form action="editcat.php?cat=<?php echo $id; ?>" method="POST">
